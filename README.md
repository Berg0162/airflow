...
During operation a sequence of informative screens are shown on the Blue Oled display that detail the measured or calculated critical values that determine the Heat Balance Equation. On the top bar icons are shown that represent the status of BLE connections (Smart Phone, Power, Heart Rate Monitor) and the double chevron indicates whether you are gaining or loosing internal heat. Every 10 seconds the content of a new screen is shown. The user can switch at any time screens to be shown in the sequence <b>on/off</b>, in accordance with his/her preference and with the help of the Airflow Companion App (<b>Display Settings</b>).
...
If you want to know in more detail about the science, math and implementation...<br> [See RT-Critical-Power](https://github.com/Berg0162/RT-Critical-Power)<br>
