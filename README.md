...
<img src="../main/images/AIRFLOW_equation.png" width="400" height="100" align = "middle" alt="Airflow equation"> <br>
The Heat Balance Equation can be rewritten in such a way that the requested Airflow velocity (<b>Va</b>) is a function of the other terms and can be calculated!
