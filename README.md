...
# How to measure the terms of Heat Balance Equation <br>
. Heart Rate Monitor (Dual ANT+ and) Bluetooth LE transmitter
The AIRFLOW device needs continuous measurement of the heart rate to determine the mean body temperature which is proportionally to the netto heat that is stored in the body.
Most cyclists are used to wear a heart rate band during workout and when that band is transmitting data over BLE it will be suitable for the AIRFLOW device. Notice that many of the (older) devices allow only <b>one</b> BLE connection at the time, which means that you cannot concurrently connect your cyling computer and Zwift computer and/or AIRFLOW device over BLE... If possible: Use ANT+ for regular conncetions and only BLE for the AIRFLOW device!
. Any Power meter with (Dual ANT+ and) Bluetooth LE transmitter
The AIRFLOW device needs continuous measurement of the cycling power, produced during a workout, to determine how much energy is produced.
The power meter of your smart trainer can supply the power measurements that you push during a workout. Or a dedicated power meter mounted on the bike at the crank, pedals or rear hub as long as it is capable of transmitting power data over Bluetooth Low Energy (BLE). Notice that many of the (older) devices allow only <b>one</b> BLE connection at the time, which means that you cannot concurrently connect your cyling computer and Zwift computer and/or AIRFLOW device over BLE... If possible: Use ANT+ for regular conncetions and only BLE for the AIRFLOW device!
. Temperature & Humidity Sensor
Ambient air temperature and relative humidity are critical variables during any serious workout. These are measured with a Adafruit sensor continously!
